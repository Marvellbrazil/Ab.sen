...
namespace App\Models {
    ...
    /**
     * App\Models\Bergabung
     *
     * @property \Illuminate\Support\Carbon $updated_at
     * @property \Illuminate\Support\Carbon $created_at
     * @property mixed $id_kelas
     * @property mixed $id_account
     * @property mixed $id_bergabung
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung whereIdBergabung($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung whereIdAccount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung whereIdKelas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Bergabung>|Bergabung query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Bergabung extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereIdPresensi($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereIdAccount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereIdKelas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereLinkFoto($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereLinkVideo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Presensi>|Presensi whereDeskripsi($value)
