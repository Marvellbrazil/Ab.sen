        ...
        <div class="container-fluid py-4 px-5">
            ...
            <div class="row mt-4">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="w-100">
                                            ...
                                            <h3 class="mb-2 font-weight-bold">8</h3>
                                            <div class="d-flex align-items-center">
                                                <span class="text-sm"><span class="text-success">+2</span> minggu
                                                    ini</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="w-100">
                                            ...
                                            <h3 class="mb-2 font-weight-bold">21</h3>
                                            <div class="d-flex align-items-center">
                                                <span class="text-sm">notifikasi belum terbaca</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card border shadow-xs mb-xl-0" role="button" data-bs-toggle="modal"
                ...
                <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
                    <div class="card shadow-xs border h-100">
                        <div class="card-header pb-0">
                            ...
                            <p class="text-sm">Data Presensi Kumulatif</p>
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off"
                                    checked>
                                <label class="btn btn-white px-3 mb-0" for="btnradio1">7 hari</label>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
                                <label class="btn btn-white px-3 mb-0" for="btnradio2">30 hari</label>
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
                                <label class="btn btn-white px-3 mb-0" for="btnradio3">12 bulan</label>
                            </div>
                        </div>
            ...
            <!-- Modal Gabung Kelas -->
            <div class="modal fade" id="gabungKelasModal" tabindex="-1" aria-labelledby="gabungKelasLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg">
                        <div class="modal-header">
                            <h5 class="modal-title fw-bold" id="gabungKelasLabel">
                                <i class="fa-solid fa-door-open me-2"></i>Gabung Kelas
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                        </div>
                        <div class="modal-body">
                            <form id="formGabungKelas">
                                <div class="mb-3">
                                    <label for="kodeKelas" class="form-label fw-semibold">Kode Kelas</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="formGabungKelas" class="btn btn-dark">Gabung</button>
                        </div>
                    </div>
                </div>
            </div>
