...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/abdotsen(1).jpg') }}">
    <link rel="icon" type="image/png" href="{{ asset('assets/img/abdotsen(1).jpg') }}">
    <link rel="shortcut icon" href="{{ asset('assets/img/abdotsen(1).jpg') }}" type="image/x-icon">
    <title>
        @yield('title', 'Ab.sen - Presensi Online')
    </title>
    <!-- SweetAlert2 -->
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    var ctx2 = document.getElementById("chart-line").getContext("2d"); //ERROR null
